...
class LagrangianHeuristicSolver1 : public CEDPSolver {
    private:
        /*
        ...
        double solveLagrangianRelaxationSubproblem1(
                ...
                unsigned int eId, const std::vector<double> & dTilde);
