...
int main (int argc, char * argv[]) {
    ...
    if (argParser.cmdOptionExists("--instance") && argParser.cmdOptionExists("--time-limit")) {
        ...
        LinearRelaxationSolver solver = LinearRelaxationSolver(instance, timeLimit, seed);
        ...
        std::cerr << "./LinearRelaxationSolverExec " << 
            "--instance <instanceFilename> --time-limit <timeLimit> " << 
            "--seed <seed> --statistics <solverStatisticsFilename> " << 
