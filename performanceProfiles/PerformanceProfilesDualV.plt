...
set xrange [1:]
set yrange [0:100]
plot "performanceProfiles/dualV".V.".csv" using 1:2 with steps linewidth 3 title "B\\&B", "performanceProfiles/dualV".V.".csv" using 1:3 with steps linewidth 3 title "B\\&C"
